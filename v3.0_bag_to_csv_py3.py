...
Edited by Max Duverneuil and Xinyu Cao 2024 August to allow for use with Velodyne Decoder 3.0
...
for bagFile in listOfBagFiles:
	...
	for topicName in listOfTopics:
		...
		if not os.path.exists(filename):
			...
			if topicName == '/sick_lms_5xx/scan': #convert this topic into txt file 
				...
				for stamp, points, topic, scan_frame_id in vd.read_bag(bagName, config, topicName, as_pcl_structs = True):
					...
					try:
						...
						pass
						print ('this folder already exists:', sub_folder)
				...
				File.close()
			elif topicName == '/ouster01/lidar_packets':
			...
			print ('This file  already exists:', filename)
